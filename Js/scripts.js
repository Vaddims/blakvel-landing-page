...
(function ($) {
    ...
    const lightMode = localStorage.getItem('BLAKVEL_COLORTHEME');
	...
	$('#themeColorToggler').on('click', function () {
		toggleColorTheme();
		const lightMode = localStorage.getItem('BLAKVEL_COLORTHEME');
		localStorage.setItem('BLAKVEL_COLORTHEME', lightMode === null ? false : lightMode === 'true' ? 'false' : 'true');
	});
